...
import boyAlive from "./picJs/BoyAlive.js"
import boyDead from "./picJs/BoyDead.js"
import frozenBrain from "./picJs/FrozenBrain.js"
import freezerOpen from "./picJs/FreezerOpen.js"
import fridgeOpen from "./picJs/FridgeOpen.js"
import meltingBrain from "./picJs/MeltingBrain.js"
import brain from "./picJs/Brain.js"
            ...
            case 69:
                ...
                if (player.position.x >= 40 && player.position.x < 160 && fridgeOpenOBJ == false) {
                    genericObjects.push(new GenericObject({
                        ...
                        image: createImage(fridgeOpen)
                    }))
                    genericObjects.push(new GenericObject({
                        x: 80,
                        y: 363,

                        image: createImage(boyDead)
                    }))
                    genericObjects.push(new GenericObject({
                        x: 146,
                        y: 565,
                ...
                if (player.position.x >= 40 && player.position.x < 160 && player.position.y < 400 && freezerOpenOBJ == false) {
                    genericObjects.push(new GenericObject({
                        ...
                        image: createImage(freezerOpen)
                    }))
                    genericObjects.push(new GenericObject({
                        x: 130,
                        y: 280,

                        image: createImage(frozenBrain)
                    }))
                    freezerOpenOBJ = true
                    return
                }
                ...
                if (player.position.x >= 350 && player.position.x < 540 && frozenBrainOBJ == true && thawedBrain == false) {
                    ...
                    setTimeout(function () {
                        ...
                        genericObjects.push(new GenericObject({
                            x: 505,
                            y: 487,
                            image: createImage(meltingBrain)
                        }))
                        setTimeout(function () {
                            genericObjects.pop()
                            genericObjects.push(new GenericObject({
